  ...
  return (
    <main className="min-h-screen overflow-hidden">
      <div className="flex flex-col items-center justify-start relative gap-8">
        <div className="flex flex-col gap-2 items-start justify-center max-w-6xl m-auto p-8 md:p-16 ">
          <Link href="/" className="font-light underline">
            Home
          </Link>
          <div className="mt-8 flex flex-col gap-2 items-start justify-center font-light">
            <p>
              <strong>Privacy Policy for My Website</strong>
            </p>
            <p></p>
            <p>
              My Website one of our main priorities is the privacy of our
              visitors. This Privacy Policy document contains types of
              information that is collected and recorded by My Website and how
              we use it.
            </p>
            <p></p>
            <p>
            ...
            <p>
              ...
              that they shared and/or collect in&My Website. This policy is not
            ...
            <p>
              ...
              agree to its terms. This Privacy Policy has been generated with
              the{" "}
            ...
            <p>
              ...
              Policy at the following URL &ndash;{" "}
            ...
            <p>
              ...
              the advertising partners of&My Website.
            </p>
            <p></p>
            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on&My Website,
            ...
            <p></p>
            <p>
              Note that My Website has no access to or control over these
            ...
            <p></p>
            <p>
              My Website&apos;s Privacy Policy does not apply to other
            ...
            <ul>
              ...
              <li>
                The right to erasure &ndash; You have the right to request that
