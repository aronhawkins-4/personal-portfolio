export const ExperienceSection = () => {
  return (
    <div className="w-full max-w-7xl flex flex-col gap-4 items-start pb-16  px-8 md:px-16">
      ...
      <div className="py-8 border-b border-white w-full flex justify-between items-end card-hover">
        <div className="flex flex-col gap-2">
          <h3 className="text-3xl uppercase font-semibold">Higgins AI</h3>
          <p className="text-lg text-gray-300">Lead Engineer</p>
        </div>
