...
export const WorkContainer = () => {
    return (
        <div className="flex flex-col gap-24 w-full lg:max-w-6xl items-center">
            <div className="flex gap-16 justify-between items-center w-full">
                <div className="flex flex-col gap-4 items-center justify-center">
                    <div className="w-[1px] h-16 bg-white/50 mb-8"></div>
                    <h3
                        className="text-3xl font-thin opacity-50 tracking-[1.5rem]"
                        style={{
                ...
                <div className="flex flex-col gap-4 w-full lg:max-w-6xl">
                    <WebsiteCard
                        ...
                        mediaLinks={[
                            'sendero_home',
                            'sendero_mega_menu',
                            'sendero_product_page',
                            'sendero_category_grid',
                        ]}
                    />
                    <WebsiteCard
