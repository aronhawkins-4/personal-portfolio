  ...
  return (
    <div ref={ref} className="relative w-full h-full" style={{ height: Math.max(...heights) }}>
      {transitions((style, item) => (
        // @ts-expect-error error with a.div
        <a.div
          key={item.id}
          style={style}
        ...
        >
          <div
            className="relative w-full h-full overflow-hidden uppercase text-[10px] leading-[10px] rounded-xl shadow-[0px_10px_50px_-10px_rgba(0,0,0,0.2)] transition duration-300 ease hover:scale-110"
            style={{
